...
export default function TeamMembers() {
	const teamMembers = [
		{ id: 1, name: "Благица Коцева-Тодорова", position: "Претседателка", image: blagica },
		{ id: 2, name: "Јоана Коцева", position: "Потпретседателка", image: joana },
		{ id: 3, name: "Анастасија Танева", position: "Психотерапевт", image: anastasija },
		{ id: 4, name: "Билјана Ташева", position: "Правна советничка", image: biljana },
		{ id: 5, name: "Марија Камчева", position: "Лице за комуникација", image: marija },
