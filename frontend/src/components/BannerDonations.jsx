...
import donationsBannerImage from "../images/banner_images/banner_donations.png";

export default function BannerDonations() {
	...
	return (
		<section
			...
			style={{ backgroundImage: `url(${donationsBannerImage})` }}
		>
			...
			<div className="relative mx-auto flex h-72 w-full max-w-6xl items-center justify-center px-6 sm:h-88 md:h-108 lg:h-120">
				...
				>
					...
					<p className="mx-auto mt-5 max-w-2xl text-sm font-medium leading-relaxed text-white/95 sm:text-base md:text-lg">
						Со секоја поддршка помагате повеќе жени и деца да добијат безбеден простор, стручна помош и нова надеж.
					</p>
				</div>
			</div>
		</section>
