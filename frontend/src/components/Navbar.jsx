...
export default function Navbar() {
    ...
    useEffect(() => {
        const handleScroll = () => {
            ...
            if (currentScrollY < 16 || mobileMenuIsOpen) {
    ...
    return (
        <>
            <nav
                className={`fixed inset-x-0 top-0 z-50 border-b border-purple-200 bg-linear-to-r from-purple-50/90 via-white to-purple-100/80 shadow-sm backdrop-blur-md transition-transform duration-300 ${
